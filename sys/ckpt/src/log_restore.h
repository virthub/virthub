...
#ifdef LOG_RESTORE_CPU
#define log_restore_cpu log_debug
#else
#define log_restore_cpu(...) do {} while (0)
#endif
...
#ifdef LOG_RESTORE_EXT
#define log_restore_ext log_debug
#else
#define log_restore_ext(...) do {} while (0)
#endif
