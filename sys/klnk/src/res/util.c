...
int vres_can_expose(vres_t *resource)
{
...
int vres_can_restart(vres_t *resource)
{
...
int vres_is_local(vres_op_t op)
{
...
int vres_need_timed_lock(vres_t *resource)
{
	return VRES_OP_CANCEL == vres_get_op(resource);
}


int vres_need_half_lock(vres_t *resource)
{
	return VRES_OP_SHMFAULT == vres_get_op(resource);
}


int vres_need_lock(vres_t *resource)
{
	vres_op_t op = vres_get_op(resource);
...
int vres_need_wrlock(vres_t *resource)
{
